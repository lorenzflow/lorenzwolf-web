...
My full thesis can be downloaded {{< staticref "uploads/FDA Thesis.pdf" "newtab" >}}here{{< /staticref >}} and slides for the talk {{< staticref "uploads/FDA_Slides.pdf" "newtab" >}}here{{< /staticref >}}.
